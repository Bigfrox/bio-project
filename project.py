...
def GetPPI_with_edge_based_method(filename, annotation_BP, annotation_MF, ontology_BP, ontology_MF, annotation_dict_BP,annotation_dict_MF):
...
def main():
    ...
    gene_sim = GetPPI_with_edge_based_method(input_filename3, BP_annotation, MF_annotation, ontology_BP, ontology_MF,annotation_dict_BP,annotation_dict_MF)
    print("PPI READ end")
    ...
    SE = list()
    OMSP = list()
    gene_sim, SE, OMSP = roc_curve(gene_sim,SE,OMSP)
